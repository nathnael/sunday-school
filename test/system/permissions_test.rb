...
class PermissionsTest < ApplicationSystemTestCase
  ...
  test "creating a Permission" do
    ...
    fill_in "Created by", with: @permission.created_by
    fill_in "Deleted at", with: @permission.deleted_at
    fill_in "Description", with: @permission.description
    fill_in "Modified by", with: @permission.modified_by
    fill_in "Name", with: @permission.name
    fill_in "User type", with: @permission.user_type

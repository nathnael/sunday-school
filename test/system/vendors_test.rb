...
class VendorsTest < ApplicationSystemTestCase
  ...
  test "creating a Vendor" do
    ...
    fill_in "Created by", with: @vendor.created_by
    fill_in "Deleted at", with: @vendor.deleted_at
    fill_in "Modified by", with: @vendor.modified_by
    fill_in "Name", with: @vendor.name
    fill_in "Org unit", with: @vendor.org_unit
